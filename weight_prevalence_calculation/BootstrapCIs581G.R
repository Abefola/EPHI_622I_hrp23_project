...
#Tegede
prop_res <- c(0,0.0625,0.058139535
)
pf_N <- c(33,65,196)
N = sum(pf_N)
x <- weighted.mean(prop_res, pf_N)
...
#Kule
prop_res <- c(0.166666667,0.125,0.047619048
)
pf_N <- c(7,4,460)
N = sum(pf_N)
x <- weighted.mean(prop_res, pf_N)
...
#Atseged Tsimbila
prop_res <- c(0.333333333,0.043478261,0.090909091
)
pf_N <- c(26,48,86)
N = sum(pf_N)
x <- weighted.mean(prop_res, pf_N)
...
#K/Humera
prop_res <- c(0.142857143, 0.083333333, 0.064516129)
pf_N <- c(21,39,112)
N = sum(pf_N)
x <- weighted.mean(prop_res, pf_N)
x_N <- x * N
