...
# Quara
prop_res <- c(0,0,0.0232558139534884)
pf_N <- c(42, 39, 435)
N = sum(pf_N)
x <- weighted.mean(prop_res, pf_N)
x_N <- x * N
...
#Tegede
prop_res <- c(0.50,0.0967741935483871,0.308823529411765)
pf_N <- c(33,65,196)
N = sum(pf_N)
x <- weighted.mean(prop_res, pf_N)
x_N <- x * N
...
#W Armachiho
prop_res <- c(0,0.0256410256410256,.107142857142857)
pf_N <- c(32,75,187)
N = sum(pf_N)
x <- weighted.mean(prop_res, pf_N)
x_N <- x * N
...
#Itang
prop_res <- c(1,0,.111111111111111)
pf_N <- c(5,2,144)
N = sum(pf_N)
x <- weighted.mean(prop_res, pf_N)
x_N <- x * N
...
#Ahferom
prop_res <- c(0,0,0.166666666666667)
pf_N <- c(16,18,83)
N = sum(pf_N)
x <- weighted.mean(prop_res, pf_N)
x_N <- x * N
...
#Atseged Tsimbila
prop_res <- c(0,0.0416666666666667, 0)
pf_N <- c(26,48,86)
N = sum(pf_N)
x <- weighted.mean(prop_res, pf_N)
x_N <- x * N
...
#Gulomekeda
prop_res <- c(0,0,0.111111111111111)
pf_N <- c(2,3,14)
N = sum(pf_N)
x <- weighted.mean(prop_res, pf_N)
x_N <- x * N
...
#K/Humera
prop_res <- c(0,0.0714285714285714,0.0769230769230769)
pf_N <- c(21,39,112)
N = sum(pf_N)
x <- weighted.mean(prop_res, pf_N)
x_N <- x * N
...
#L. Adiabo
prop_res <- c(0,0,0.153846153846154)
pf_N <- c(11,22,111)
N = sum(pf_N)
x <- weighted.mean(prop_res, pf_N)
x_N <- x * N
...
#T/Adaibo
prop_res <- c(0,0,0.222222222222222)
pf_N <- c(6,10,51)
N = sum(pf_N)
x <- weighted.mean(prop_res, pf_N)
x_N <- x * N
