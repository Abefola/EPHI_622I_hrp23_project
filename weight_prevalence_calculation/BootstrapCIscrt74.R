...
# Quara
prop_res <- c(1,0.846153846, 0.731707317
)
pf_N <- c(42, 39, 435)
N = sum(pf_N)
x <- weighted.mean(prop_res, pf_N)
...
#Kule
prop_res <- c(1,0.875,0.736842105
...
#Atseged Tsimbila
prop_res <- c(0.666666667, 1, 0.777777778
...
#Gulomekeda
prop_res <- c(0.857142857, 0.666666667,0.791666667)
pf_N <- c(2,3,14)
N = sum(pf_N)
x <- weighted.mean(prop_res, pf_N)
x_N <- x * N
